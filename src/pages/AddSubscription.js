...
const AddSubscription = () => {
  ...
  const DELETE_TYPES_OF_SUBSCRIPTION = (e,indexNumber)=>{
     e.preventDefault();
     setTypesOfSubscription(TypesOfSubscription.filter(ele=>ele !== TypesOfSubscription[indexNumber]));
  }
                ...
                <div className="profile-details reset-margin-padding flex flex-wrap mt-10 mr-25">
                  ...
                  />
                   ...
                   </div>
                   {
                      ...
                      features.map((ele,index)=>{
                          return (
                            <div key={index} className='bg-blue text-white mt-1 flex'>
                            <p>{ele}</p>
                            <button>
                              <Icon name="delete" size="2xl" onClick={(e)=>DELETE_FEATURE(e,index)} />
                            </button>
                            </div>
                          )
                      })
                  ...
                  <div className="w-full lg:w-12/12 pr-4 mb-10 font-light">
                  {
                      ...
                      TypesOfSubscription.map((ele,index)=>{
                          return (
                            <div key={index} className='bg-blue text-white mt-1 flex space-beteeen'>
                            <p>{`${ele.subscriptionTypeText}-US$ ${ele.cost}/${ele.day}`}</p>
                            
                            <button>
                              <Icon name="delete" size="2xl" onClick={(e)=>DELETE_TYPES_OF_SUBSCRIPTION(e,index)} />
                            </button>
                            </div>
                          )
                      })
