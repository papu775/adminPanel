...
//   };
    ...
    const ADD_COUPON = async (e)=>{
        e.preventDefault();
         try {
            const res = await addCoupon({startDate,endDate,couponName,couponCode,noOfCoupon,discountType,discountAmount,everyPersonUsed});
            if(res.ok){
                ...
                <Card>
                    ...
                    <CardHeader  contentPosition="none" className="bg-blue">
                        <div className="w-full flex items-center justify-between">
                            <h2 className="text-white text-2xl">Add New Coupon</h2>
                        </div>
                    </CardHeader>
                    <CardBody>
                    <form id="edit-profile-form" onSubmit={ADD_COUPON}>        
                    <div className='row reset-margin-padding'>
                        <div className="profile-details reset-margin-padding flex flex-wrap mt-10 mr-25">
                            <div className="w-full lg:w-6/12 pr-4 mb-10 font-light">
                                ...
                                />
                                {/* <p className='text-red-600' id="errMsgCouponName">{errMsgCouponName}</p> */}
                            </div>
                            <div className="w-full lg:w-6/12 pl-4 mb-10 font-light">
                                ...
                                />
                                {/* <p className='text-red-600'>Coupon Code Required</p> */}
                            </div>
                            <div className="w-full lg:w-6/12 pr-4 mb-10 font-light">
                                <Input
                                    type="number"
                            ...
                            <div className="w-full lg:w-6/12 pl-4 mb-10 font-light">
                                <Input
                                    type="number"
                                    color="purple"
                                    placeholder={"Max Usage Coupon Every Person"}
