...
const EditCoupon = () => {
  ...
  //     var mm = new Date().getMonth(); //January is 0!
  ...
  const [startDate, setStartDate] = useState(new Date("2022/09/27"));
  ...
  const FETCH_COUPON = async () => {
    try {
      ...
      // setTempStartDate(new Date(res.data.data.startDate));
    } catch (error) {
      console.error(error);
    }
  };
                ...
                <div className="profile-details reset-margin-padding flex flex-wrap mt-10 mr-25">
                  ...
                  <div className="w-full lg:w-6/12 pr-4 mb-10 font-light">
                    ...
                    >
                      ...
                      <option
                        value="Flat"
                        selected={discountType === "Flat" ? true : false}
                      >
                        Flat
                      </option>
                      <option
                        value="Percentage"
                        selected={discountType === "Percentage" ? true : false}
                      >
                        Percentage
                      </option>
                    </select>
